...
var fileDescriptor_80127c65a2f83c7f = []byte{
	...
	,
}
...
func (m *AccessClientListEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.User) > 0 {
		i -= len(m.User)
		copy(dAtA[i:], m.User)
		i = encodeVarintAccessClientListEntry(dAtA, i, uint64(len(m.User)))
		i--
		dAtA[i] = 0xa
	}
