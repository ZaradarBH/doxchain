...
func NewMsgTokenRequest(creator string, tenantW3CIdentifier string, clientId string, clientSecret string, scope []string, grantType string, deviceCode string, authorizationCode string, clientAssertion string, clientAssertionType string) *MsgTokenRequest {
